...
Savet: Sve ove rute podržavaju $select, $filter i $expand parametre. Na primer, ako želiš samo listu biblioteka sa njihovim imenima, koristi GET /dms/{index}/drives?$select=id,name. To će ti značajno ubrzati aplikaciju i smanjiti nepotreban saobraćaj.